...
<font color="black" ><b>     <center>       <h1> Delete/Update Division </h1>
        <form action="deleteDivisionAction.jsp">
        <%
        try{
...
cellspacing="2">
                       ...
                       <% while(rs1.next()){ %>
    <tr><td> <input type="checkbox" name="rowid" value="<%=rs1.getInt("divisionid")%>"</td><%
                          //for(int i=1;i<=column;i++)
                            //                         {
        %>
        
        <td><input type="text" name="divisionname" value="<%=rs1.getString("divisionname")%>"/></td>
