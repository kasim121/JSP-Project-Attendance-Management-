  ...
  //alert(n);
    ...
    // out.println(txtenrollment+ "Student for "+txtpgmcode+ " is valid student ");
             ...
             <script>alert('Teacher already exist '); 
               window.location.replace("http://localhost:38356/AMSystem/Master/Teacher/createTeacher.jsp");
           </script>
             %>
       ...
       <script>alert('Teachers data created'); 
           window.location.replace("http://localhost:38356/AMSystem/Master/Teacher/createTeacher.jsp");</script>
         <%}
