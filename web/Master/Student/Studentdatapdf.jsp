<%-- 
    Document   : Studentdatapdf
    Created on : 22 Feb, 2018, 10:03:05 PM
    Author     : KasimPC
--%>
...
{ 
    ...
    String query = "select * from studentinfo";          //Fetching data from table
 ...
 // PdfPCell cell = new com.lowagie.text.pdf.PdfPCell(new Paragraph(rsmd.getColumnName(i)));
       PdfPCell cell1 = new com.lowagie.text.pdf.PdfPCell(new Paragraph("Student Name"));
       PdfPCell cell2 = new com.lowagie.text.pdf.PdfPCell(new Paragraph("Student ID"));
       PdfPCell cell3 = new com.lowagie.text.pdf.PdfPCell(new Paragraph("Address"));
       PdfPCell cell4 = new com.lowagie.text.pdf.PdfPCell(new Paragraph("Gender"));
       PdfPCell cell5 = new com.lowagie.text.pdf.PdfPCell(new Paragraph("Email ID"));
       PdfPCell cell6 = new com.lowagie.text.pdf.PdfPCell(new Paragraph("Mobile"));
       PdfPCell cell7 = new com.lowagie.text.pdf.PdfPCell(new Paragraph("Division"));
       PdfPCell cell8 = new com.lowagie.text.pdf.PdfPCell(new Paragraph("Standard"));
       PdfPCell cell9 = new com.lowagie.text.pdf.PdfPCell(new Paragraph("Roll No"));
